...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_I4BHB().pack(_x.registerValue, _x.enableBridge, _x.enableMotor, _x.releaseBrake, _x.embeddedMotCom, _x.controlMode, _x.clearFaults))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.publisher = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (_x.registerValue, _x.enableBridge, _x.enableMotor, _x.releaseBrake, _x.embeddedMotCom, _x.controlMode, _x.clearFaults,) = _get_struct_I4BHB().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_I4BHB = None
def _get_struct_I4BHB():
    global _struct_I4BHB
    if _struct_I4BHB is None:
        _struct_I4BHB = struct.Struct("<I4BHB")
    return _struct_I4BHB
_struct_d = None
def _get_struct_d():
    global _struct_d
