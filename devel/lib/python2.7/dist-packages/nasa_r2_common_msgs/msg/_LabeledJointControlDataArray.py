  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v6.state,) = _get_struct_B().unpack(str[start:end])
        _v7 = val1.commandMode
        start = end
        end += 1
        (_v7.state,) = _get_struct_B().unpack(str[start:end])
        ...
        (_v9.state,) = _get_struct_B().unpack(str[start:end])
        _v10 = val1.coeffState
        start = end
        end += 1
        (_v10.state,) = _get_struct_B().unpack(str[start:end])
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v16.state,) = _get_struct_B().unpack(str[start:end])
        _v17 = val1.commandMode
        start = end
        end += 1
        (_v17.state,) = _get_struct_B().unpack(str[start:end])
        _v18 = val1.calibrationMode
        start = end
        end += 1
        (_v18.state,) = _get_struct_B().unpack(str[start:end])
        _v19 = val1.clearFaultMode
        start = end
        end += 1
        (_v19.state,) = _get_struct_B().unpack(str[start:end])
        _v20 = val1.coeffState
        start = end
        end += 1
        (_v20.state,) = _get_struct_B().unpack(str[start:end])
        self.data.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
