...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_I2B().pack(_x.registerValue, _x.logicEnabled, _x.motorEnabled))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.registerValue, _x.logicEnabled, _x.motorEnabled,) = _get_struct_I2B().unpack(str[start:end])
