...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5B().pack(_x.controlMode.state, _x.commandMode.state, _x.calibrationMode.state, _x.clearFaultMode.state, _x.coeffState.state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.controlMode.state, _x.commandMode.state, _x.calibrationMode.state, _x.clearFaultMode.state, _x.coeffState.state,) = _get_struct_5B().unpack(str[start:end])
      return self
