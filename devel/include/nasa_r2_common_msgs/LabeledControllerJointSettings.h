...
struct LabeledControllerJointSettings_
{
  ...
  _joint_names_type joint_names;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _jointVelocityLimits_type;
  _jointVelocityLimits_type jointVelocityLimits;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _jointAccelerationLimits_type;
...
bool operator==(const ::nasa_r2_common_msgs::LabeledControllerJointSettings_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::LabeledControllerJointSettings_<ContainerAllocator2> & rhs)
{
  return lhs.originator == rhs.originator &&
    lhs.joint_names == rhs.joint_names &&
    lhs.jointVelocityLimits == rhs.jointVelocityLimits &&
    lhs.jointAccelerationLimits == rhs.jointAccelerationLimits;
}
