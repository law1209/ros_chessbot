...
bool operator==(const ::nasa_r2_common_msgs::ControllerJointSettings_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::ControllerJointSettings_<ContainerAllocator2> & rhs)
{
