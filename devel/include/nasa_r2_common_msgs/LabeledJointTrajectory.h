...
bool operator==(const ::nasa_r2_common_msgs::LabeledJointTrajectory_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::LabeledJointTrajectory_<ContainerAllocator2> & rhs)
{
