...
struct SetTipNameRequest_
{
  ...
  _arm_name_type arm_name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _tip_name_type;
...
bool operator==(const ::nasa_r2_common_msgs::SetTipNameRequest_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::SetTipNameRequest_<ContainerAllocator2> & rhs)
{
  return lhs.arm_name == rhs.arm_name &&
    lhs.tip_name == rhs.tip_name;
}
...
struct Printer< ::nasa_r2_common_msgs::SetTipNameRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nasa_r2_common_msgs::SetTipNameRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "tip_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.tip_name);
  }
};
