...
struct LabeledJointControlDataArray_
{
  ...
  _originator_type originator;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _joint_type;
  _joint_type joint;

   typedef std::vector< ::nasa_r2_common_msgs::JointControlData_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::nasa_r2_common_msgs::JointControlData_<ContainerAllocator> >> _data_type;
  _data_type data;
...
bool operator==(const ::nasa_r2_common_msgs::LabeledJointControlDataArray_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::LabeledJointControlDataArray_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::nasa_r2_common_msgs::LabeledJointControlDataArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nasa_r2_common_msgs::LabeledJointControlDataArray_<ContainerAllocator>& v)
  {
    ...
    {
      s << indent << "  joint[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.joint[i]);
    }
