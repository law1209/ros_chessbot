...
bool operator==(const ::nasa_r2_common_msgs::JointControlData_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::JointControlData_<ContainerAllocator2> & rhs)
{
  return lhs.controlMode == rhs.controlMode &&
    lhs.commandMode == rhs.commandMode &&
    lhs.calibrationMode == rhs.calibrationMode &&
    lhs.clearFaultMode == rhs.clearFaultMode &&
    lhs.coeffState == rhs.coeffState;
}
