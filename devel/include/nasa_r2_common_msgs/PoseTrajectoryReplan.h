...
bool operator==(const ::nasa_r2_common_msgs::PoseTrajectoryReplan_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::PoseTrajectoryReplan_<ContainerAllocator2> & rhs)
{
