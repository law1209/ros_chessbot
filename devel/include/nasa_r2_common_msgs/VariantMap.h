...
struct VariantMap_
{
  ...
  _message_type message;
   ...
   typedef std::vector< ::nasa_r2_common_msgs::ValueType_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::nasa_r2_common_msgs::ValueType_<ContainerAllocator> >> _value_type;
  _value_type value;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _stringMap_type;
  _stringMap_type stringMap;

   typedef std::vector<uint16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint16_t>> _uint16Map_type;
  _uint16Map_type uint16Map;

   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _int16Map_type;
  _int16Map_type int16Map;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _uint32Map_type;
  _uint32Map_type uint32Map;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _int32Map_type;
  _int32Map_type int32Map;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _float32Map_type;
  _float32Map_type float32Map;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _boolMap_type;
...
bool operator==(const ::nasa_r2_common_msgs::VariantMap_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::VariantMap_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.message == rhs.message &&
    lhs.value == rhs.value &&
    lhs.stringMap == rhs.stringMap &&
    lhs.uint16Map == rhs.uint16Map &&
    lhs.int16Map == rhs.int16Map &&
    lhs.uint32Map == rhs.uint32Map &&
    lhs.int32Map == rhs.int32Map &&
    lhs.float32Map == rhs.float32Map &&
    lhs.boolMap == rhs.boolMap;
}
...
struct Printer< ::nasa_r2_common_msgs::VariantMap_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nasa_r2_common_msgs::VariantMap_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.stringMap.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.stringMap[i]);
    }
