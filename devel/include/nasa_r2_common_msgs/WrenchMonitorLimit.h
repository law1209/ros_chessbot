...
struct WrenchMonitorLimit_
{
  ...
  _torque_type torque;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _isFraction_type;
...
bool operator==(const ::nasa_r2_common_msgs::WrenchMonitorLimit_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::WrenchMonitorLimit_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.name == rhs.name &&
    lhs.force == rhs.force &&
    lhs.torque == rhs.torque &&
    lhs.isFraction == rhs.isFraction;
}
