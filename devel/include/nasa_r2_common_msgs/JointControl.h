...
bool operator==(const ::nasa_r2_common_msgs::JointControl_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::JointControl_<ContainerAllocator2> & rhs)
{
  return lhs.publisher == rhs.publisher &&
    lhs.timeStamp == rhs.timeStamp &&
    lhs.joint == rhs.joint &&
    lhs.registerValue == rhs.registerValue &&
    lhs.enableBridge == rhs.enableBridge &&
    lhs.enableMotor == rhs.enableMotor &&
    lhs.releaseBrake == rhs.releaseBrake &&
    lhs.embeddedMotCom == rhs.embeddedMotCom &&
    lhs.controlMode == rhs.controlMode &&
    lhs.clearFaults == rhs.clearFaults;
}
