...
bool operator==(const ::nasa_r2_common_msgs::JointControlDataArray_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::JointControlDataArray_<ContainerAllocator2> & rhs)
{
