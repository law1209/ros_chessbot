...
bool operator==(const ::nasa_r2_common_msgs::SetParameterResponse_<ContainerAllocator1> & lhs, const ::nasa_r2_common_msgs::SetParameterResponse_<ContainerAllocator2> & rhs)
{
