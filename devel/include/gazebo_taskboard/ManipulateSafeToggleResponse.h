...
bool operator==(const ::gazebo_taskboard::ManipulateSafeToggleResponse_<ContainerAllocator1> & lhs, const ::gazebo_taskboard::ManipulateSafeToggleResponse_<ContainerAllocator2> & rhs)
{
