...
(cl:defclass <LabeledJointControlDataArray> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass LabeledJointControlDataArray (<LabeledJointControlDataArray>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LabeledJointControlDataArray>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LabeledJointControlDataArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nasa_r2_common_msgs-msg:<LabeledJointControlDataArray> is deprecated: use nasa_r2_common_msgs-msg:LabeledJointControlDataArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LabeledJointControlDataArray>))
...
(cl:defmethod originator-val ((m <LabeledJointControlDataArray>))
...
(cl:defmethod joint-val ((m <LabeledJointControlDataArray>))
...
(cl:defmethod data-val ((m <LabeledJointControlDataArray>))
  ...
  (data m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LabeledJointControlDataArray>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LabeledJointControlDataArray>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LabeledJointControlDataArray>)))
  "Returns string type for a message object of type '<LabeledJointControlDataArray>"
  "nasa_r2_common_msgs/LabeledJointControlDataArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LabeledJointControlDataArray)))
  "Returns string type for a message object of type 'LabeledJointControlDataArray"
  "nasa_r2_common_msgs/LabeledJointControlDataArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LabeledJointControlDataArray>)))
  "Returns md5sum for a message object of type '<LabeledJointControlDataArray>"
  "4bff9298a6988a564ac5d64f88f9ea87")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LabeledJointControlDataArray)))
  "Returns md5sum for a message object of type 'LabeledJointControlDataArray"
  "4bff9298a6988a564ac5d64f88f9ea87")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LabeledJointControlDataArray>)))
  "Returns full string definition for message of type '<LabeledJointControlDataArray>"
  (cl:format cl:nil "Header header~%string originator~%string[] joint~%JointControlData[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlData~%JointControlMode            controlMode~%JointControlCommandMode     commandMode~%JointControlCalibrationMode calibrationMode~%JointControlClearFaultMode  clearFaultMode~%JointControlCoeffState      coeffState~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlMode~%uint8 state~%uint8 IGNORE     = 0~%uint8 INVALID    = 1~%uint8 BOOTLOADER = 2~%uint8 FAULTED    = 3~%uint8 SAFE       = 4~%uint8 OFF        = 5~%uint8 PARK       = 6~%uint8 NEUTRAL    = 7~%uint8 DRIVE      = 8~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCommandMode~%uint8 state~%uint8 IGNORE          = 0~%uint8 INVALID         = 1~%uint8 MOTCOM          = 2~%uint8 MULTILOOPSTEP   = 3~%uint8 MULTILOOPSMOOTH = 4~%uint8 ACTUATOR        = 5~%uint8 STALLMODE       = 6~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCalibrationMode~%uint8 state~%uint8 IGNORE       = 0~%uint8 DISABLE      = 1~%uint8 ENABLE       = 2~%uint8 UNCALIBRATED = 3~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlClearFaultMode~%uint8 state~%uint8 IGNORE  = 0~%uint8 DISABLE = 1~%uint8 ENABLE  = 2~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCoeffState~%uint8 state~%uint8 NOTLOADED = 0~%uint8 LOADED    = 1~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LabeledJointControlDataArray)))
  "Returns full string definition for message of type 'LabeledJointControlDataArray"
  (cl:format cl:nil "Header header~%string originator~%string[] joint~%JointControlData[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlData~%JointControlMode            controlMode~%JointControlCommandMode     commandMode~%JointControlCalibrationMode calibrationMode~%JointControlClearFaultMode  clearFaultMode~%JointControlCoeffState      coeffState~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlMode~%uint8 state~%uint8 IGNORE     = 0~%uint8 INVALID    = 1~%uint8 BOOTLOADER = 2~%uint8 FAULTED    = 3~%uint8 SAFE       = 4~%uint8 OFF        = 5~%uint8 PARK       = 6~%uint8 NEUTRAL    = 7~%uint8 DRIVE      = 8~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCommandMode~%uint8 state~%uint8 IGNORE          = 0~%uint8 INVALID         = 1~%uint8 MOTCOM          = 2~%uint8 MULTILOOPSTEP   = 3~%uint8 MULTILOOPSMOOTH = 4~%uint8 ACTUATOR        = 5~%uint8 STALLMODE       = 6~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCalibrationMode~%uint8 state~%uint8 IGNORE       = 0~%uint8 DISABLE      = 1~%uint8 ENABLE       = 2~%uint8 UNCALIBRATED = 3~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlClearFaultMode~%uint8 state~%uint8 IGNORE  = 0~%uint8 DISABLE = 1~%uint8 ENABLE  = 2~%~%================================================================================~%MSG: nasa_r2_common_msgs/JointControlCoeffState~%uint8 state~%uint8 NOTLOADED = 0~%uint8 LOADED    = 1~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LabeledJointControlDataArray>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LabeledJointControlDataArray>))
  "Converts a ROS message object to a list"
  (cl:list 'LabeledJointControlDataArray
