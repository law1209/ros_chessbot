...
class LabeledGains {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LabeledGains
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LabeledGains
    let len;
    let data = new LabeledGains(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LabeledGains(null);
