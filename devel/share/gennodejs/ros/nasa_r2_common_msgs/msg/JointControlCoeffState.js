...
class JointControlCoeffState {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointControlCoeffState(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointControlCoeffState(null);
...
JointControlCoeffState.Constants = {
  NOTLOADED: 0,
  LOADED: 1,
}

module.exports = JointControlCoeffState;
